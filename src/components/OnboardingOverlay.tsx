...
const STEPS = [
  { title: 'Welcome to the Board', body: 'Your head is already full. That\'s what this board is for. Three columns — Now, Soon, Later — to sort it all out and clear your head.' },
  { title: 'Now. Soon. Later.', body: 'Do this now. Do this next. Do this later. Drag tasks between columns as your day changes. Nothing gets forgotten.' },
